...
import { Plus, Truck, Pencil, MoreHorizontal } from "lucide-react";
  ...
  return (
    <div className="space-y-4 admin-dense">
      <PageHeader
        ...
        actions={<button className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-primary text-primary-foreground rounded-md hover:bg-primary-hover"><Plus className="h-3.5 w-3.5" /> Thêm NCC</button>}
      />
